...
//</editor-fold>
    ...
    public boolean checkProperty(Property p) {
        for (int i = 0; i < this.MyProperties.size(); i++) {
            if (p.equals(MyProperties.get(i))) {
                return true;
            }
        }
        return false;
...
//    public void tradeP2M(ArrayList<Property> Pr1, int m,Player P1,Player P2) {
//
//        for (int i = 0; i < Pr1.size(); i++) {
//            P2.addProperty(Pr1.get(i));
//            P1.removeProperty(Pr1.get(i));
...
//    }
//
//    public void tradeM2P(ArrayList<Property> Pr, int m,Player P1,Player P2) {
//
//        for (int i = 0; i < Pr.size(); i++) {
//            P1.addProperty(Pr.get(i));
//            P2.removeProperty(Pr.get(i));
//        }
//        P2.addMoney(m);
//
//    }
